            ...
            <div className="flex lg:justify-between justify-center mt-8 ">
              <div className="font-medium text-lg lg:text-start text-center lg:text-left ">
                <h3 className="text-white">
                  Nombre de Usuario: <p>Juan Martin</p>
                </h3>
                <div className="text-white text-sm my-2">
                  Email:
                  <div className="text-green-300 text-sm my-2">juanMartin@asobal.es</div>
                </div>
          ...
          <div className="grid grid-cols-2">
            <div className="grid-span-2 px-10">
              <img
                ...
                alt="a"
              ></img>
              <img src="https://i.ibb.co/zJ9N9BP/bronze.png" className="h-36" alt="a"></img>
            </div>
            <div className="grid-span-2 px-10">
              <img
                ...
                alt="a"
              ></img>
              <img src="https://i.ibb.co/V9YQrNQ/silver.png" className="h-36" alt="a"></img>
            </div>
          </div>
        </div>
      </div>
